...
export async function getKmbStops(route: string, bound: string, serviceType: string): Promise<StopInfo[]> {
...
export async function getKmbEta(stopId: string, route: string, serviceType: string): Promise<EtaItem[]> {
